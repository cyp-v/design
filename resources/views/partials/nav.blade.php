    ...
    <ul id="nav-mobile" class="medium right hide-on-med-and-down">
      ...
      <li><a href="#!" class="dropdown-button" data-activates="burger_menu"><i class="material-icons">menu</i></a></li>
        <ul id="burger_menu" class="dropdown-content">
          ...
          <li><a href="#!">vous impliquer</a></li>
          <li><a href="#!">contact</a></li>
        </ul>
      <li><a href="#!" class="dropdown-button" data-activates="burger_menu"><i class="material-icons">perm_identity</i></a></li>
        <ul id="user_menu" class="dropdown-content">
          <li><a href="#!">mon profil</a></li>
          <li><a href="#!">mes projets</a></li>
          <li class="divider"></li>
          <li><a href="#!">déconnexion</a></li>
          {{-- ICI CONDITION SELON DROITS UTILISATEUR ! --}}
          <li><a href="#!">éditer les projets</a></li>
          <li><a href="#!">éditer les actualités</a></li>
          <li><a href="#!">mon profil</a></li>
          <li class="divider"></li>
          <li><a href="#!">déconnexion</a></li>
        </ul>
